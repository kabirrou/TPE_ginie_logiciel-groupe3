...
<title>CITIES SPACE-Admin</title>
...
<div class="container-fluid text-center">    
  ...
  <div class="container">
    ...
    <div class="container contact-form"> 
      ...
      <div class="col-md-4">
        ...
        <a href="accepter?idch=${ch.idChambre}"><button type="button" class="btn btn-primary btn-lg">Accepter</button></a>
        <a href="refuser?idch=${ch.idChambre}"><button type="button" class="btn btn-secondary btn-lg">Refuser</button></a>
  ...
  <div class="container">
    ...
    <div class="container contact-form"> 
       ...
       <div class="col-md-6">
        <div class="service-desc">
          <h3>Liste des chambres occupe</h3>
          <c:forEach items="${listechambre}" var="ch">
           <c:if test="${ch.photos=='accepter'}">
          <h4> Chambre :${ch.nomchambre}: Mm/Mr ${ch.locataire.prenomLocataire} </h4>
          <p>Adresse mail :${ch.locataire.adresseEmail }
          </p>
          </c:if>
          </c:forEach> 
