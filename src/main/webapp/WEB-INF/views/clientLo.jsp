      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 col-md-offset-2 intro-text">
            <h1>Bienvenue sur<br>
              CITIES SPACE</h1>
            <p>Votre plateforme de présentation de cité et mini cité, et d'aide à l	a réservation de chambres dans celles-ci...</p>
    ...
    <div class="row">
      ...
      <div class="col-xs-12 col-md-10">
        <div class="about-text">
          <h2><center>Vous souhaitez réserver la chambre ${chambre.nomchambre } dans la cite ${chambre.cite.nomCite }...</center></h2>
          <br>
          <h3><center>Inscrivez-vous sur Cities Space via le formulaire suivant pour effectuer la réservation</center></h3>
          <h3>${erreur}</h3>
          ...
          <div class="list-style">
            ...
            <div class="col-lg-6 col-sm-6 col-xs-12">
              <ul>
                <li>Numero de la Carte National d'Identité : 
                ...
                <li>Situation matrimoniale :
                        <f:select path="statuSocial" class="form-control">
                           <f:option value="Celibataire">Célibataire</f:option>
                           <f:option value="marie">Marié(e)</f:option>
                        </f:select>
...
<div id="testimonials">
  <div class="container">
    <div class="section-title">
       <h2>Les chambres de la cité ${cite.nomCite}</h2>
       <h4>Propriétaire: ${cite.proprietaire.nomProprietaire}
